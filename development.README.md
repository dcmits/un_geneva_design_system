...
ddev serve
```
4. launch the storybook app from ddev (in a separate terminal) or go to https://un-geneva-desing-system.ddev.site
```
ddev launch
```
5. add/modify components
6. rebuild static files for production
```
ddev build
```
7. deploy
